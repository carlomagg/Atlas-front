...
const TopNavigation = ({ activeTab, onTabChange }) => {
  ...
  const tabs = [
    ...
    {
      name: 'Transaction Activities',
      href: '/dashboard/transaction-activities',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      href: '/dashboard/payment-platform',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const isTabActive = (tab) => {
    ...
    if (tab.name === 'Company Info') {
      return location.pathname.includes('/contact-info') ||
             location.pathname.includes('/product-info') ||
             location.pathname.includes('/quotation-builder') ||
             location.pathname.includes('/privacy-info');
    }
